...
function super_maps_line_style(){

    global $wpdb;

    $print = "<div class='new-link margin-top-20'><a href='admin.php?page=super-maps&p=newLineStyle'><span class='dashicons dashicons-plus'></span> ".__('Dodaj stil linije', 'super-maps')."</a></div>";
    ...
    $results = $wpdb->get_results( 'SELECT * FROM '. SUPERMAPS_DB_STYLE_LINE, OBJECT );
    ...
    foreach($results as $r){
        ...
        $print .= "<td><a href='admin.php?page=super-maps&p=editLineStyle&style=".$r->id."'><span class='dashicons dashicons-edit'></span></a> <a href='admin.php?page=super-maps&p=delLineStyle&style=".$r->id."'><span class='dashicons dashicons-trash'></span></a></td>";
        $print .= "</tr>";
    }
...
function super_maps_line_style_add(){
    ...
    $print .= "<form class='super-maps' action='admin.php?page=super-maps&p=newLineStyle' method='POST'>";
    $print .= "<div>";
...
function super_maps_Line_style_edit(){
    ...
    $style = $wpdb->get_row("SELECT * FROM ".SUPERMAPS_DB_STYLE_LINE." WHERE id = $id");
    ...
    $print .= "<form class='super-maps' action='admin.php?page=super-maps&p=editLineStyle&style=".$id."' method='POST'>";
...
function super_maps_Line_style_del(){

    global $wpdb;

    $id = intval($_GET['style']);

    $wpdb->delete( SUPERMAPS_DB_STYLE_LINE, array( 'ID' => $id ) );
